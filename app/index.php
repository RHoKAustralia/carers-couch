...
<html class="no-js" lang="">
    ...
    <form id="signIn" onsubmit="return validateLogInForm()" action="home.html" method="post" >
        <input type="hidden" value="prof">
    </form>
    <form id="enter" action="home.html" method="post" >
        <input type="hidden" value="prof">
    </form>
    ...
    <header class="header_index" style="min-height: 500px">
        ...
        <div id="buttons" style="margin-left: 40%;position: relative;top: 140px">
            <p>
                <input id="email" name="email" type="text" placeholder="EMAIL" style="width:390px;height:40px">
            </p>
            <p>
                <input id="password" name="password" type="text" placeholder="PASSWORD" style="width:390px;height:40px">
            </p>
            <p >
